...
export const ms = {
  ...
  aset: {
    ...
    aduan: {
      tajuk: "Aduan Kerosakan",
      laporkanAduan: "Laporkan Aduan",
      labelFasiliti: "Fasiliti",
      labelKategori: "Kategori",
      labelKeterukan: "Keterukan",
      labelKeterangan: "Keterangan",
      hantar: "Hantar Aduan",
      tandaTindakan: "Tanda Dalam Tindakan",
      tandaSelesai: "Tanda Selesai",
      tiadaAduan: "Tiada aduan kerosakan direkodkan.",
      kategori: {
        awam_sivil: "Awam & Sivil",
        elektrikal: "Elektrikal",
        mekanikal: "Mekanikal",
        paip_saliran: "Paip & Saliran",
        keselamatan: "Keselamatan",
        landskap_kebersihan: "Landskap & Kebersihan",
      },
      keterukan: {
        kritikal: "Kritikal",
        major: "Major",
      ...
      lajurTarikhLapor: "Tarikh Hantar",
      lajurTarikhTindakan: "Tarikh Tindakan",
      lajurDiambilOleh: "Diambil Oleh",
      lajurTarikhSelesai: "Tarikh Selesai",
    },
    dashboard: {
      tajuk: "Papan Pemuka",
      ...
      senaraiPremisButang: "Senarai Semua Premis",
      senaraiPremisTajuk: "Semua Premis",
      senaraiPremisFasiliti: (n: number) => `${n} fasiliti`,
      aduanTajuk: "Aduan Kerosakan Terbuka",
      tiadaAduanTerbuka: "Tiada aduan kerosakan terbuka.",
    },
  },
  tempahan: {
    tajuk: "Tempahan",
